...
public class CommonTextUI : MonoBehaviour
{
    ...
    private Vector3 screenOffset = new Vector3(0, Screen.height * 0.01f, 0);
    ...
    public void SetData(Vector3 vec3Position, string strText, Color color)
    {
