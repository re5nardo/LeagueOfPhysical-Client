...
public class PhotonTypeRegister
{
    public static void Register()
    {
        ...
        PhotonPeer.RegisterType(typeof(SC_ProcessInputData), CustomSerializationCode.SC_ProcessInputData, Util.CommonDataCompressionSerialize, Util.CommonDataCompressionDeserialize);
