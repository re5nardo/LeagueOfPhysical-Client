...
public class PhotonTypeRegister
{
    public static void Register()
    {
        ...
        PhotonPeer.RegisterType(typeof(SC_ProcessMoveInputData), CustomSerializationCode.SC_ProcessMoveInputData, Util.CommonDataCompressionSerialize, Util.CommonDataCompressionDeserialize);
        ...
        PhotonPeer.RegisterType(typeof(SC_GameState), CustomSerializationCode.SC_GameState, Util.CommonDataCompressionSerialize, Util.CommonDataCompressionDeserialize);
        PhotonPeer.RegisterType(typeof(SC_GameEnd), CustomSerializationCode.SC_GameEnd, Util.CommonDataCompressionSerialize, Util.CommonDataCompressionDeserialize);
        ...
        PhotonPeer.RegisterType(typeof(CS_GamePreparation), CustomSerializationCode.CS_GamePreparation, Util.CommonDataCompressionSerialize, Util.CommonDataCompressionDeserialize);
